// 음식 카테고리 중 기타를 나타내는 컴포넌트이다.
import { Link } from "react-router-dom";
import { useEffect, useState } from "react";
import {HeartOutlined, HeartFilled} from '@ant-design/icons';
import './LikeButton.css'
function Etc({ id, name, address, type, likeNum, seatNum, coverImg, isRequest, nickName, userId, foodTag}) {
...
const initialSet = function (){
  ...
  return (
    ...
    }} className={'col-lg-4 '+ 'col-md-6 ' + 'portfolio-item ' + 'filter-etc '}>
