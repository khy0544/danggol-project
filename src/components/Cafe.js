// 음식 카테고리 중 카페/디저트를 나타내는 컴포넌트이다.
import { useEffect, useState } from "react";
import {HeartOutlined, HeartFilled} from '@ant-design/icons';
import './LikeButton.css'
import { Link } from "react-router-dom";
function Cafe({ id, name, address, type, likeNum, seatNum, coverImg, isRequest, nickName, userId, foodTag}) {
...
const initialSet = function (){
  ...
  return (
    ...
    }} className={'col-lg-4 '+ 'col-md-6 ' + 'portfolio-item ' + 'filter-cafe '}>
