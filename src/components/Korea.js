// 음식 카테고리 중 한식을 나타내는 컴포넌트이다. 
import { Link } from "react-router-dom";
import { useEffect, useState } from "react";
import {HeartOutlined, HeartFilled} from '@ant-design/icons';
import './LikeButton.css'
function Korea({ id, name, address, type, likeNum, seatNum, coverImg, isRequest, nickName, userId, reviewAll, foodTag}) {
...
const getReviewAll = async () => {
  ...
  return (
    ...
    }} className={'col-lg-4 '+ 'col-md-6 ' + 'portfolio-item ' + 'filter-korea '}>
